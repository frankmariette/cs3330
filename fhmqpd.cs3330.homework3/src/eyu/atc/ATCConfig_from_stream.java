...
public class ATCConfig_from_stream implements ATCConfig
{
  ...
  /**
   * Constructor. takes in reader and a string of configurations. 
   * @param n
   * @param reader
   */
...
/**
 * Validates input for configuration and then returns true if no errors
 * are thrown. 
 */
 ...
 */
  ...
  /**
   * Parses line info and makes sure input is valid
   * 
   * @param lines
   * @param max_line
   * @throws ParseException
